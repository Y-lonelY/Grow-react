...
[react]
- 开发 group 添加和修改功能，考虑到误删除会有较大损失，所以暂时不开放删除功能
- 完善 group 添加和修改功能开发
- 开发添加 trivia 功能，发现一个问题，在重新请求表单列表之后，重新打开表单内容不会变化，通过调用 `resetFields` 来进行解决
- 完成 trivia 基本模块的开发
...
处理错误捕获过程中遇到的问题，修改捕获接口，部分字段能够接受空字符串
